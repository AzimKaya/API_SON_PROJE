...
public class C08_JSONObjectVerileriniCagırma {
    ...
    public void jsonObje01(){
        ...
        addres.put("streetAddress","naist street");
        addres.put("city","Nara");
        addres.put("postalCode","630-0192");

        JSONObject kisiBilgisi=new JSONObject();
        kisiBilgisi.put("firstName","John");
        kisiBilgisi.put("lastName","doe");
        kisiBilgisi.put("age",26);
        kisiBilgisi.put( "address",addres);
        kisiBilgisi.put("phoneNumbers",phoneNumber);

        System.out.println("kişibilgisi:"+kisiBilgisi);
