...
public class C23_Get_DeSerializatio  extends DummyBaseURL {
...
specDummy.pathParams("pp1","api","pp2","v1","pp3","employee","pp4",3);
        ...
        assertEquals(testDataDummy.basariliStatusCodu,response.getStatusCode());
        assertEquals(testDataDummy.contecnType,response.getContentType());
