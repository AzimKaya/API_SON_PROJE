...
public class JesonPlaceRequestBodyPojo {
    /*
     {
    "title":"Ahmet",
    "body":"Merhaba",
    ...
    public JesonPlaceRequestBodyPojo(String title, String body, int userId, int id) {
        this.title = title;
        this.body = body;
        this.userId = userId;
        this.id = id;
    ...
    public JesonPlaceRequestBodyPojo() {
    }
    ...
    public String toString() {
        return "JesonPlaceRequestBodyPojo{" + // {title='Ahmet', body='Merhaba' ,userId=70, id=3}
                "title='" + title + '\'' +
                ", body='" + body + '\'' +
                ", userId=" + userId +
                ", id=" + id +
